/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.api.jsonc` (hash: 3dabedba1f71bc591ad4530c6df936b7)
// Runtime types generated with workerd@1.20260911.1 2026-09-14 nodejs_compat
interface __BaseEnv_Env {
	CV_FILES: KVNamespace;
...
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/api");
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TURNSTILE_SECRET_KEY" | "ALLOWED_ORIGINS" | "PUBLIC_BASE_URL">> {}
}
